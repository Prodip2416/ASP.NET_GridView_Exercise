...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="EmployeeId" DataSourceID="ObjectDataSource1" ShowFooter="True">
                <Columns>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetAllEmployees" TypeName="InsertUpdateDeleteUningObjectDataSourc.EmployeeDataAccessLayer" UpdateMethod="UpdateEmployee">
                <DeleteParameters>
                    <asp:Parameter Name="empDelete" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
